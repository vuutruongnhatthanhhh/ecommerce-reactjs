...
const ImageBox: React.FC<ImageBoxProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
      <div className="bg-white p-4 rounded relative w-[95vw] sm:w-[90vw] md:w-[100vh] max-h-[100vh] overflow-y-auto">
        {/* button close popup */}
        <button
        ...
        <div className="flex items-center gap-3 mb-4">
          <button
            ...
            className={`p-2 rounded ${
              viewMode === "image" ? "bg-blue-600 text-white" : "border"
            }`}
            type="button"
          >
            <FileImage />
          ...
          <button
            ...
            className={`p-2 rounded ${
              viewMode === "name" ? "bg-blue-600 text-white" : "border"
            }`}
            type="button"
          >
            <List />
        ...
        <input
          ...
          className="w-full bg-white sm:w-[300px] border p-2 rounded text-black"
        />
                  ...
                  <div key={img.id} className="relative group p-1 rounded">
                    {viewMode === "image" ? (
                      <>
                        ...
                        >
                          <div className="w-full aspect-square border border-gray-300 rounded overflow-hidden relative ">
                            {!isLoaded && (
